                        ...
                        for category in ordered_ui_categories():
                            if category=="prompt": toprow.create_inline_toprow_prompts()
                                ...
                                with gr.Row(elem_id="txt2img_accordions", elem_classes="accordions"):
                                    with InputAccordion(False, label="Hires. fix", elem_id="txt2img_hr-checkbox") as enable_hr:
    ...
    with gr.Blocks(analytics_enabled=False,head=canvas_head) as img2img_interface:
        ...
        with extra_tabs_img2img:
            with gr.Tab("Generation",id="img2img_generation") as img2img_generation_tab, ResizeHandleRow(equal_height=False):
                ...
                init_img_inpaint = gr.Image(); init_mask_inpaint = gr.Image();
                parameters_copypaste.add_paste_fields("inpaint", init_img_inpaint, [])
                mask_blur = gr.Slider(); mask_alpha = gr.Slider(); inpainting_fill = gr.Radio()
                ...
                img2img_resize_mode = gr.Radio(); img2img_inpaint_full_res = gr.Radio(elem_id="img2img_inpaint_full_res"); img2img_inpaint_full_res_padding = gr.Slider(); img2img_inpainting_mask_invert = gr.Radio()
                img2img_batch_input_dir = gr.Textbox(elem_id="img2img_batch_input_dir"); img2img_batch_output_dir = gr.Textbox(elem_id="img2img_batch_output_dir"); img2img_batch_inpaint_mask_dir = gr.Textbox(elem_id="img2img_batch_inpaint_mask_dir")
                ...
                safe_img2img_custom_inputs = [comp for comp in img2img_custom_inputs if comp is not None]
