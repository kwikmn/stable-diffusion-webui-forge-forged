...
def create_output_panel(tabname,outdir,toprow=None):
    ...
    with gr.Column(variant='compact',elem_id=f"{tabname}_results_column"):
        ...
        return OutputPanel(gallery=result_gallery,generation_info=generation_info,infotext=infotext,html_log=html_log,save_button=save_button,zip_button=zip_button,button_upscale=ToolButton(value=opts.samples_upscale_button_label,visible=False),button_live_preview=ToolButton(value=opts.live_preview_button_label,visible=False),button_skip=ToolButton(value='Skip',elem_id=f"{tabname}_skip",visible=False),button_interrupt=ToolButton(value='Interrupt',elem_id=f"{tabname}_interrupt",visible=False),button_stop_generating=ToolButton(value='Stop',elem_id=f"{tabname}_stop_generating",visible=False))
